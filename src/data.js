...
const data = {
  ...
  dashBoardPage: {
    ...
    browserUsage: [
      {name: 'GMAIL', value: 800, color: cyan600, icon: <ExpandMore/>},
      {name: 'GMAIL_CALENDAR', value: 300, color: pink600, icon: <ChevronRight/>},
      {name: 'SALESFORCE', value: 300, color: purple600, icon: <ExpandLess/>}
    ]
